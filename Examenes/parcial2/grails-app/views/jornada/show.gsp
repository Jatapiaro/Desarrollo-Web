...
<html>
    ...
    <body>
        ...
        <div id="show-jornada" class="content scaffold-show" role="main">
            ...
            <f:display bean="jornada" />
            <g:form resource="${this.jornada}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.jornada}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
